...
def nedc_apply_montage(params_a, fsamp_a, sig_a, labels_a, montage=None, matchmode=None): # EDITTED 12/04/2021
     ...
     # input to the output
     #
     if montage is None and KEYWORD_NULL in params_a[KEYWORD_MONTAGE.lower()]:
          return (fsamp_a, sig_a, labels_a)
